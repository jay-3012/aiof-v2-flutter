...
part of 'log_exercise_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LogExerciseRequest _$LogExerciseRequestFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'LogExerciseRequest',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$LogExerciseRequestToJson(LogExerciseRequest instance) =>
    <String, dynamic>{
