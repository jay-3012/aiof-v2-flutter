...
class UserProfileApi {
  ...
  Future<Response<ApiResponseVoid>> deactivateAccount({
    ...
    final _path = r'/api/users/account';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseUserResponse>> getUserProfile({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<ApiResponseUserResponse, ApiResponseUserResponse>(
              rawData, 'ApiResponseUserResponse',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ApiResponseUserResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiResponseUserResponse>> updateUserProfile({
